...
import useLikedSpaces from "../../src/hooks/useLikedSpaces";
...
const getHeaderTheme = (isDark) =>
  isDark ? headerGradients.home.dark : headerGradients.home.light;
const getTimeOfDay = () => {
  ...
  return (
    <View style={qbStyles.wrapper}>
      <LinearGradient
        colors={
          isDark
            ? ["#1a0533", "#2d1060", "#1a0533"]
            : ["#ede9fe", "#ddd6fe", "#ede9fe"]
        }
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
  ...
  return (
    <Animated.View style={{ opacity, transform: [{ scale }] }}>
      <TouchableOpacity
        onPress={onPress}
        activeOpacity={0.88}
        style={[fcStyles.card, { width: CARD_WIDTH }]}
      >
        <View style={fcStyles.imageBox}>
          {space.images?.[0] ? (
            ...
            >
              <LinearGradient
                colors={["transparent", "rgba(10,6,30,0.82)"]}
                style={fcStyles.imgOverlay}
              />
            </ImageBackground>
          ) : (
            <LinearGradient
          ...
          <TouchableOpacity
            onPress={handleLike}
            style={fcStyles.likeButton}
            activeOpacity={0.8}
          >
            <Animated.View style={{ transform: [{ scale: likeScaleAnim }] }}>
              <View
                style={[fcStyles.likeRing, liked && fcStyles.likeRingActive]}
              >
                <Ionicons
          ...
          <View style={fcStyles.imgContent}>
            <View
              style={[fcStyles.typePill, { backgroundColor: accent + "CC" }]}
            >
              <Text style={fcStyles.typeText}>{space.category || "Space"}</Text>
            </View>
            <Text style={fcStyles.cardName} numberOfLines={2}>
              {space.name}
            </Text>
            <View style={fcStyles.cardMeta}>
              ...
              />
              <Text style={fcStyles.metaText}>
                {space.location?.city || "Prime Location"}
              </Text>
              <View style={fcStyles.ratingBadge}>
                <Ionicons name="star" size={10} color="#F59E0B" />
                <Text style={fcStyles.ratingText}>
                  {space.rating?.toFixed(1) || "4.8"}
                </Text>
              </View>
            </View>
          </View>
        ...
        <View style={fcStyles.priceBadge}>
          ...
          <Text style={fcStyles.priceValue}>
...
export default function HomeScreen() {
  ...
  const { data: featuredData } = useQuery({
    queryKey: ["featured"],
    queryFn: () =>
      spacesAPI.getAll({ featured: true, limit: 50 }).then((res) => res.data),
  });
  ...
  const featuredSpaces =
    recommendationsData?.spaces?.length > 0
    ...
    >
          ...
          <View style={styles.nameBlock}>
            <Text
              style={[
                ...
                { color: currentHeaderTheme.greetingColor },
              ]}
            >
              Good {getTimeOfDay()} <Text style={styles.sparkle}>✦</Text>
            </Text>
            ...
            {user?.hostApplicationStatus === "verified" ? (
              ...
              >
                ...
                />
                <Text style={[styles.locationText, { color: "#1E0A4A" }]}>
                  Verified Host
                </Text>
              </View>
            ) : (
          ...
          <View style={styles.headerActions}>
            ...
            >
              <Ionicons
                ...
                size={18}
                color={currentHeaderTheme.iconColor}
              />
            </TouchableOpacity>
          </View>
        </View>
      ...
      >
        ...
        >
          ...
          <Text
            style={{ color: colors.textLight, fontSize: 12, fontWeight: "500" }}
          >
            {spaces.length > 0
              ? `${spaces.length} spaces available`
              : "Discovering spaces near you..."}
          </Text>
        </View>
            ...
            >
              ...
              {user?.hostApplicationStatus === "verified" && (
                <TouchableOpacity
                  ...
                  onPress={() => router.push("/admin/spaces")}
                >
                  <Ionicons
                  ...
                  />
                  <Text
                    style={[styles.listPropertyText, { color: colors.white }]}
                  >
                    List Your Property
                  </Text>
                </TouchableOpacity>
