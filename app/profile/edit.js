          ...
          <View style={styles.inputGroup}>
            ...
            {user?.phone && user?.phoneVerified ? (
              ...
              >
                ...
                />
                <Text
                  style={[styles.verifiedPhoneText, { color: colors.success }]}
                >
                  {user.phone}
                </Text>
              </View>
              ...
              <View style={styles.inputRow}>
                ...
                <TouchableOpacity
                  ...
                  disabled={
                    sendOTPMutation.isPending || pendingPhone.length !== 10
                  }
                >
        ...
        >
          ...
          >
            ...
            <TextInput
              style={[
                styles.otpInput,
                { backgroundColor: colors.gray100, color: colors.textPrimary },
              ]}
              value={otp}
              onChangeText={setOtp}
            ...
            >
              {verifyOTPMutation.isPending ? (
                <Text
                  style={[styles.verifyButtonText, { color: colors.white }]}
                >
                  Verifying...
                </Text>
              ) : (
