    ...
    >
      ...
      >
        <View style={styles.content}>
          <View
            style={[styles.logoSection, { backgroundColor: colors.primary }]}
          >
          ...
          >
            ...
            <Text style={[styles.description, { color: colors.textSecondary }]}>
              PosomePa is a modern rental platform designed to simplify the
              process of finding and booking spaces for various needs. Whether
              you're looking for office spaces, event halls, studios, or
              temporary accommodations, we connect you with verified property
              owners across multiple cities.
            </Text>
            <Text style={[styles.description, { color: colors.textSecondary }]}>
              Our platform offers hourly, daily, and monthly booking options,
              giving you the flexibility to rent spaces according to your
              convenience. With features like AI-powered recommendations, secure
              payments, and real-time availability, PosomePa ensures a seamless
              booking experience.
            </Text>
          </View>
          ...
          <View style={styles.featureItem}>
            ...
            <View style={styles.featureContent}>
              ...
              >
                Find spaces across multiple categories with smart
                recommendations
              </Text>
            </View>
          </View>
          ...
          <View style={styles.featureItem}>
            ...
            <View style={styles.featureContent}>
              ...
              <Text
                style={[styles.featureDesc, { color: colors.textSecondary }]}
              >
                Book by hour, day, or month based on your needs
              </Text>
            </View>
          </View>
