...
import { formatTimeAgo, isThreadClosed, getTimeRemaining } from "../../src/utils/helpers";
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Delete",
          style: "destructive",
          onPress: () => deleteMutation.mutate(selectedMessage._id),
        },
      ],
    );
  };
          ...
          <View style={styles.propertyInfo}>
            <Image
              source={{
                uri:
                  property?.images?.[0] ||
                  "https://placehold.co/60x60/8B5CF6/ffffff?text=Property",
              }}
            ...
            selectedMessage.threadsRemaining > 0 && (
              <View style={styles.newThreadNotice}>
                ...
                <Text style={styles.newThreadNoticeText}>
                  This thread has ended. You can start a new conversation from
                  the property page.
                </Text>
              </View>
            )}
            ...
            selectedMessage.threadsRemaining === 0 && (
              <View style={styles.noMoreThreadsNotice}>
                ...
                <Text style={styles.noMoreThreadsNoticeText}>
                  You have used all 2 allowed conversations for this property.
                  No further messaging is possible.
                </Text>
              </View>
            )}
            ...
            {isThreadClosed(selectedMessage) && (
              <View style={styles.threadClosedBanner}>
                ...
                <Text style={styles.threadClosedText}>
                  Thread closed. Visit the property page to start a new
                  conversation.
                </Text>
              </View>
            )}
      ...
      <PageHeader
        ...
        subtitle={
          messages.length > 0
            ...
            : "Drop your doubts, wait for replies"
        }
        showBack={true}
        onBack={() => router.back()}
      />
          ...
          messages.map((message) => {
            ...
            return (
              ...
              >
                    ...
                    <View style={styles.notificationTitleRow}>
                      ...
                      {closed && (
                        <View style={styles.closedChip}>
                          <Text style={styles.closedChipText}>
                            New thread needed
                          </Text>
                        </View>
                      )}
                ...
                <Text
                  style={[styles.previewText, closed && styles.closedPreview]}
                  numberOfLines={2}
                >
                  {hasReply
