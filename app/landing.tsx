...
const IconSearch = () => (
  <Svg width={IC} height={IC} viewBox="0 0 24 24" fill="none">
    <Circle cx="10.5" cy="10.5" r="6.5" stroke={IC_C} strokeWidth="2" />
    <SvgLine
      x1="15.5"
      y1="15.5"
      x2="21"
...
const IconCalendar = () => (
  <Svg width={IC} height={IC} viewBox="0 0 24 24" fill="none">
    <SvgRect
      ...
      strokeWidth="2"
    />
    <SvgLine x1="3" y1="9" x2="21" y2="9" stroke={IC_C} strokeWidth="2" />
    <SvgLine
      x1="8"
      y1="2"
      x2="8"
...
const IconCheck = () => (
  <Svg width={IC} height={IC} viewBox="0 0 24 24" fill="none">
    <Circle cx="12" cy="12" r="9" stroke={IC_C} strokeWidth="2" />
    <SvgPath
      d="M8 12.5l3 3 5-5.5"
      stroke={IC_C}
      strokeWidth="2"
...
export default function LandingScreen() {
  ...
  return (
    <View style={s.container}>
      ...
      <LinearGradient
        colors={["#1A0836", "#270E62", "#350660"]}
        start={{ x: 0.2, y: 0 }}
        end={{ x: 0.8, y: 1 }}
        style={[s.darkHalf, { height: DARK_H }]}
      />
      <LinearGradient
        colors={["#F3EEFF", "#EDE9FE", "#FBF0FF"]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
        style={[s.lightHalf, { top: DARK_H }]}
      />
      <LinearGradient
        colors={[
          "rgba(26,8,54,0.0)",
        ...
        pointerEvents="none"
        style={[s.splitShadow, { top: DARK_H - 50, height: 100 }]}
      />
      <View
        pointerEvents="none"
        style={[s.orb, s.orb1, { top: DARK_H * 0.15 }]}
      />
      <View
        pointerEvents="none"
        style={[s.orb, s.orb2, { top: DARK_H * 0.35 }]}
      />
      <SafeAreaView style={s.safe}>
        <View style={[s.darkContent, { height: DARK_H - 40 }]}>
          <AnimatedOrbitalRings />
          <View style={s.eyebrow}>
            <Text style={s.eyebrowTxt}>Your Space, Your Time</Text>
          </View>
          <LogoAnimation />
        </View>
        <View style={s.lightContent}>
          ...
          <HowItWorks />
          <Animated.View
            style={{ transform: [{ scale }], width: "100%", marginTop: 28 }}
          >
            <TouchableOpacity
              onPressIn={pressIn}
              onPressOut={pressOut}
...
const s = StyleSheet.create({
  ...
  orb1: {
    ...
    height: 260,
    left: -80,
    backgroundColor: "rgba(124,92,246,0.26)",
  },
  orb2: {
    width: 200,
    height: 200,
    right: -60,
    backgroundColor: "rgba(232,121,201,0.16)",
  },
  safe: {
    flex: 1,
    alignItems: "center",
  ...
  eyebrow: {
    borderWidth: 1,
    borderColor: "rgba(228,176,245,0.32)",
    borderRadius: 30,
    paddingVertical: 6,
